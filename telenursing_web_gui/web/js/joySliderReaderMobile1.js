...
setInterval(function(){ sliderData.slider=Slider1.GetAngle(); }, 50);
setInterval(function(){ sendSliderData() }, 500);
...
setInterval(function(){ frData.FwdRev=Slider1.GetY(); }, 50);
setInterval(function(){ sendFRData() }, 500);
