...
leftArmCamTopic = "/camera/color/image_raw"
headCamTopic = "/camera/color/image_raw"

# create publisher objects for the republished image topics
primaryCamRepub = "/locobot/primaryCameraStream/color/image_raw"
secondaryCamRepub = "/locobot/secondaryCameraStream/color/image_raw"
