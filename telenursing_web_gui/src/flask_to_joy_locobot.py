...
primaryStreamURL = "http://localhost:8080/stream_viewer?topic=/camera/color/image_raw"
secondaryStreamURL = "http://localhost:8080/stream_viewer?topic=/camera/color/image_raw/compressedDepth"
primaryStreamCam = "head"
secondaryStreamCam = "leftArm"

# Misc variables
homeLeftArmReq = "/HomeArm"
...
def makeRobotHomeReq():
    ...
    try:
        ...
        serviceClient = rospy.ServiceProxy(homeLeftArmReq, HomeArm)
